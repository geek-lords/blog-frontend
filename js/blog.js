                    ...
                    if (blogs.hasOwnProperty(key)) {
                        ...
                        $('.fetchblog').append(`
                            ...
                            <div class="h-full bg-white rounded-xl shadow-md bg-opacity-75 px-8 pt-16 pb-24 overflow-hidden text-center relative border-2 hover:shadow-xl hover:border-purple-200 ">
                                ...
                                <p class="leading-relaxed mb-3 line-3">${content}</p>
                                <a class="text-indigo-500 inline-flex items-center cursor-pointer">Learn More
                                ...
                                <div class="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4 ">
                                    <span class="text-gray-400 mr-3 inline-flex items-center leading-none text-sm pr-3 py-1 border-r-2 border-gray-200 ">
                                            <img src="../static/like.svg " class="mr-2 h-6 w-4 cursor-pointer ">${like_count}
                            </span>
